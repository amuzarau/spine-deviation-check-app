...
st.info(
    "⚠️ Инструмент предоставляет только предварительную оценку формы позвоночника "
...
st.markdown("**Перетащите файл сюда или нажмите «Выбрать файл»**")
st.caption("Максимальный размер файла — 200 МБ")
